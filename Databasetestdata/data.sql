...
-- persons (DONT EXECUTE THESE IN THIS VERSION, these are left as example for user table data configuration)
-- PHPMyAdmin cant handle comments well, remove also these if copy pasting before executing 
--INSERT INTO person VALUES(1,'Erkki','Esimerkkinen','012345678','erkki.esimerkkinen@gmail.com',TRUE,FALSE,'2006-04-12 12:00:00',NULL);
--INSERT INTO person VALUES(2,'Ulla','Esimerkkinen','02348596','ulla.esimerkkinen@gmail.com',TRUE,FALSE,'2006-04-10 14:00:00',NULL);
--INSERT INTO person VALUES(3,'Akseli','Ollila','09485067','akseli.ollila@gmail.com',TRUE,FALSE,'2008-07-18 18:00:00',NULL);
--INSERT INTO person VALUES(4,'Omistaja','Neilikka','08590649','kauppias.kauppila@gmail.com',TRUE,TRUE,'2005-07-27 07:00:00',NULL);
--INSERT INTO person VALUES(5,'Työntekijä','Neilikka','09580694','tyontekija.neilikka@gmail.com',TRUE,TRUE,'2005-07-31 07:00:00',NULL);
