<?php
function set_user_for_the_bookmark($connection, $current_url, $current_tags){
    try{
                ...
                if($retrieve_tags_id_query->execute()){
                    ...
                    if($check_that_user_bookmark_with_tags_doesnt_exist_query->execute()){
                        ...
                        if($user_bookmark_in_folder_count == 0){
                            echo "\nFOLDERED BOOKMARK DOESN'T EXIST FOR USER ALREADY";
                            ...
                            //save_user_with_this_bookmark_and_these_tags_query->bind_param("ssi", $_SESSION["username"], $current_url);
                            ...
                            echo "\nFOLDERED BOOKMARK EXISTS FOR USER ALREADY";
                        }
        ...
        echo "\nSET USER FOR BOOKMARK, INCORRECT CONDITION CHECK";
        return false;
