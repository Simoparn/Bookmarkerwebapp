<div id="pagecontent">
  <span class="paragraphtitle">Register a new user</span>
   <p>
      ...
      <br><b>Address (at least 8 letters, space, 1-3 numbers and an optional space and a letter at the end)</b><input type="text" name="address" id="address" pattern="[a-öA-Ö]\w{8,}.[0-9]{1,3}.[a-öA-Ö\ ]\w{0,1}$"required><br>
      <br><b>Postal code (at least 5 numbers)</b><input type="text" name="postal_code" id="postal_code" pattern="[0-9]{5,}$"required><br>
      <br><b>Municipality (Capitalized initial letter, at least 4 letters total, spaces allowed)</b><input type="text" name="municipality" id="municipality" pattern="[A-Ä]{1,1}.[a-öA-Ö\ ]{3,}$"required><br>
      <select name="country">
<?php
