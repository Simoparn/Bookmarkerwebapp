...
if(!isset($_GET['database_error'])){
    echo "<br><span class=\"errormessage\">Opening password change link failed, user email or username not found based on link data <a href=\"./index.php?page=forgotten_password_form\">Refresh page</a></span>";                   
}
else{
